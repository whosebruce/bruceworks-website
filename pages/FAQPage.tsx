      ...
      <section className="bg-white pb-20">
        <div className="container mx-auto px-6 text-center">
          <p className="text-gray-600 text-lg">
            ...
            Give us a call at <a href="tel:+18668296757" className="text-gray-900 hover:text-yellow-600 font-bold hover:underline">(866) 829-6757</a> or send us a message below.
          </p>
        </div>
      </section>
