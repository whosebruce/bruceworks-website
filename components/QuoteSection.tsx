      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <blockquote className="text-2xl md:text-3xl font-medium text-white mb-8 leading-relaxed">
            "If the business only works because the owner remembers everything, the first AI project is not an isolated AI agent. It is getting the knowledge and workflow into a system the business can own."
          </blockquote>
